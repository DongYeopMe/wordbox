...
import com.wordtree.global.dto.JWTResponseDTO;
import com.wordtree.global.dto.RefreshRequestDTO;
...
public class JwtService {
    ...
    public JWTResponseDTO cookie2Header(
        ...
        // 토큰 생성
        String newAccessToken = jwtUtil.createJwt(userid, role, true);
        String newRefreshToken = jwtUtil.createJwt(userid, role, false);
    ...
    public void removeRefreshUser(String userid) {
